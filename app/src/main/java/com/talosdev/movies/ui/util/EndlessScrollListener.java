package com.talosdev.movies.ui.util;
...
//                firstVisibleItem, visibleItemCount, totalItemCount));
     ...
     * @param page
     *  The page that we will need to load (1-based). This is not the current page, so it will
     *  never be 1.
     * @param totalItemsCount
     *      The total number of items shown currently.
     * @return
     */
